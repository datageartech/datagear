...
(function(global)
{
	...
	dashboardFactory._createSuperByDashboardEditor = dashboardFactory.create;
	dashboardFactory.create = function(dashboard)
	{
		dashboard = dashboardFactory._createSuperByDashboardEditor(dashboard);
	...
	/**
	 * 获取图表元素的ChartPluginConfigForm。
	 * 
	 * @param ele 可选，元素，默认为：当前选中元素
	 */
	editor.getElementChartPluginConfigForm = function(ele)
	{
		ele = this._currentElement(ele, true);
		...
		//org.datagear.analysis.ChartPluginConfigForm
	...
	editor._buildPageStyleText = function(options)
	{
		...
		var re = "\n"
			...
			+ "  outline: 1px dashed " + options.selectedBorderColor + ";"
			+ "\n}"
			+ "\n"
	...
	{
		var webContext = chartFactory.renderContextWebContext(this.dashboard.renderContext);
