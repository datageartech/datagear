...
(function(global)
{
	...
	chartSupport.geoScatterRender = function(chart, coordSign, coordLongitudeSign, coordLatitudeSign, valueSign, options)
	{
		options = chart.options($.extend(true,
		{
			title: {
	...
	chartSupport.geoScatterUpdate = function(chart, results, coordSign, coordLongitudeSign, coordLatitudeSign, valueSign)
	{
		var chartDataSets = chart.chartDataSetsNonNull();
