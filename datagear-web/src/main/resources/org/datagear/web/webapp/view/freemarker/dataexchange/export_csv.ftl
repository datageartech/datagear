...
<div id="${pageId}" class="page-dataexchange page-dataexport-text page-dataexport-csv">
	...
	<div class="content">
		<form id="${pageId}-form" action="${contextPath}/dataexchange/${schema.id}/export/csv/doExport" method="POST">
				...
				<div>
					...
					<div class="form-item form-item-table">
						<div class="table-operation-wrapper">
							...
							<button type="button" class="table-download-all-button page-status-aware-show finish-status-show" file-name="export_csv.zip"><@spring.message code='downloadAll' /></button>
						</div>
