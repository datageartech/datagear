...
<div id="${pid}" class="page page-manager page-dataexchange page-export-data-csv h-full flex flex-column overflow-auto">
...
(function(po)
{
	po.submitUrl = "/dtbsSourceExchange/"+encodeURIComponent(po.dtbsSourceId)+"/export/csv/doExport";
