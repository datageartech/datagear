...
(function(po)
{
	...
	[
		...
		{name: "chartDataSetAttachmentFirst", value: "chartDataSetAttachmentFirst()", displayName: "chartDataSetAttachmentFirst() ", displayComment: "chart", categories: ["chart"]},
		{name: "chartDataSetMainFirst", value: "chartDataSetMainFirst()", displayName: "chartDataSetMainFirst() ", displayComment: "chart", categories: ["chart"]},
