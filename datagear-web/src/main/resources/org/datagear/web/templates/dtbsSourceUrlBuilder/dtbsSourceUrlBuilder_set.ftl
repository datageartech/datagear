...
<div id="${pid}" class="page page-form horizontal page-form-dtbsSource-ub">
...
{
  //<@spring.message code='dtbsSourceUrlBuilder.dbType.desc' />
  dbType : "MySQL",
 
  //<@spring.message code='dtbsSourceUrlBuilder.template.desc' />
  template : "jdbc:mysql://{host}:{port}/{name}",
  
  //<@spring.message code='dtbsSourceUrlBuilder.defaultValue.desc' />
  defaultValue : { host : "", port : "3306", name : "" }
}
</pre>
						<div class="flex-grow-0">
							<@spring.message code='dtbsSourceUrlBuilder.code.desc' />
						</div>
					</div>
				</div>
			</div>
...
(function(po)
{
	po.submitUrl = "/dtbsSourceUrlBuilder/saveSet";
	...
	po.vueMethod(
	{
		onPreview: function()
		{
			...
			po.open("/dtbsSourceUrlBuilder/preview",
			{
				data:
				{
