...
(function(po)
{
	po.submitUrl = "/dtbsSourceExchange/"+encodeURIComponent(po.dtbsSourceId)+"/import/sql/doImport";
	...
	po.setupImportTableHead(
			po.concatContextPath("/dtbsSourceExchange/"+encodeURIComponent(po.dtbsSourceId)+"/import/sql/uploadImportFile"),
			function(response)
			{
