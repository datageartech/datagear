...
<script src="${contextPath}/static/script/cometd-4.0.9/common/cometd.js?v=${_hh_Version}" type="text/javascript"></script>
<script src="${contextPath}/static/script/cometd-4.0.9/common/AckExtension.js?v=${_hh_Version}" type="text/javascript"></script>
<script src="${contextPath}/static/script/cometd-4.0.9/common/ReloadExtension.js?v=${_hh_Version}" type="text/javascript"></script>
<script src="${contextPath}/static/script/cometd-4.0.9/jquery/jquery.cometd.js?v=${_hh_Version}" type="text/javascript"></script>
<script src="${contextPath}/static/script/cometd-4.0.9/jquery/jquery.cometd-ack.js?v=${_hh_Version}" type="text/javascript"></script>
<script src="${contextPath}/static/script/cometd-4.0.9/jquery/jquery.cometd-reload.js?v=${_hh_Version}" type="text/javascript"></script>
