...
-->
<meta charset="utf-8" />
<meta name="description" content="DataGear是一款开源免费的数据可视化分析平台，自由制作任何数据看板，支持接入SQL、CSV、Excel、HTTP接口、JSON等多种数据源。" />
...
<link href="${contextPath}/static/analysisapi/2.0/css/style.css?v=${clientCacheCode}" type="text/css" rel="stylesheet" />
...
<script src="${contextPath}/static/analysisapi/2.0/dashboardBuiltinMap.js?v=${clientCacheCode}" type="text/javascript"></script>
