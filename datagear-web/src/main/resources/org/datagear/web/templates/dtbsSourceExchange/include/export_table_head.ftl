...
(function(po)
{
	...
	po.addAllTable = function()
	{
		...
		po.ajax("/dtbsSourceExchange/" + encodeURIComponent(po.dtbsSourceId) +"/getAllTableNames",
		{
	...
	po.setupExportTableHead = function(options)
	{
		...
		po.vueMethod(
		{
			...
			{
				var url = "/dtbsSourceExchange/" + encodeURIComponent(po.dtbsSourceId) +"/export/downloadAll";
