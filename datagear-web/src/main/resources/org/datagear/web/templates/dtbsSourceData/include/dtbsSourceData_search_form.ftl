...
(function(po)
{
	...
	po.setupSearchForm = function(dbTable)
	{
		...
		po.vuePageModel(
		{
			...
			searchNotLikeTrueDesc: "<@spring.message code='dtbsSourceData.searchForm.notLike.true.desc' />",
			searchNotLikeFalseDesc: "<@spring.message code='dtbsSourceData.searchForm.notLike.false.desc' />"
		});
