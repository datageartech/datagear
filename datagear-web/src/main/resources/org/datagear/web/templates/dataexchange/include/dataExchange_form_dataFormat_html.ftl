...
<div class="form-item">
	...
	<div class="form-item-value">
		<input type="text" name="dataFormat.dateFormat" value="${(defaultDataFormat.dateFormat)!''}" class="ui-widget ui-widget-content ui-corner-all" />
	</div>
</div>
<div class="form-item">
	<div class="form-item-label"><@spring.message code='dataExchange.dataFormat.timeFormat' /></div>
	<div class="form-item-value">
		<input type="text" name="dataFormat.timeFormat" value="${(defaultDataFormat.timeFormat)!''}" class="ui-widget ui-widget-content ui-corner-all" />
	</div>
</div>
<div class="form-item">
	<div class="form-item-label"><@spring.message code='dataExchange.dataFormat.timestampFormat' /></div>
	<div class="form-item-value">
		<input type="text" name="dataFormat.timestampFormat" value="${(defaultDataFormat.timestampFormat)!''}" class="ui-widget ui-widget-content ui-corner-all" />
	</div>
</div>
<div class="form-item">
	<div class="form-item-label"><@spring.message code='dataExchange.dataFormat.numberFormat' /></div>
	<div class="form-item-value">
		<input type="text" name="dataFormat.numberFormat" value="${(defaultDataFormat.numberFormat)!''}" class="ui-widget ui-widget-content ui-corner-all" />
	</div>
</div>
<div class="form-item form-item-binaryFormat">
	...
	<div class="form-item-value">
		<input type="text" name="dataFormat.binaryFormat" value="${(defaultDataFormat.binaryFormat)!''}" class="input-binaryFormat ui-widget ui-widget-content ui-corner-all" />
