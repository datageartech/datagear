...
<div id="${pageId}" class="page-form page-form-dashboard">
	...
	<div class="chart-list-panel auto-close-panel dg-togglable-panel minor-panel ui-widget ui-widget-content ui-corner-all ui-widget-shadow ui-front">
		...
		<form action="#" method="POST">
			...
			<div class="panel-content">
				<div class="content-item">
					...
					<input type="text" name="addResName" value="" class="ui-widget ui-widget-content ui-corner-all" />
				</div>
			</div>
		...
		<form action="#" method="POST">
			...
			<div class="panel-content">
				...
				<div class="content-item">
					...
					<input type="text" name="uploadResName" value="" class="ui-widget ui-widget-content ui-corner-all" />
		...
		<form action="#" method="POST" class="display-block">
			...
			<div class="panel-content form-content">
				<div class="form-item">
					...
					<div class="form-item-value">
						<textarea name="content" class="width-9 ui-widget ui-widget-content ui-corner-all"></textarea>
					</div>
				</div>
			</div>
	...
	<div class="veditor-style-panel veditor-panel auto-close-panel minor-panel ui-widget ui-widget-content ui-corner-all ui-widget-shadow ui-front">
		<form action="#" method="POST" class="display-37 input-width-7">
			<div class="panel-head ui-widget-header ui-corner-all">
	...
	<div class="veditor-label-panel veditor-panel auto-close-panel minor-panel ui-widget ui-widget-content ui-corner-all ui-widget-shadow ui-front">
		<form action="#" method="POST" class="display-block">
			<div class="panel-head ui-widget-header ui-corner-all">
				<@spring.message code='dashboard.veditor.label' />
			</div>
			<div class="panel-content form-content">
				<div class="form-item">
					<div class="form-item-label">
						<label><@spring.message code='dashboard.veditor.label.content' /></label>
					</div>
					<div class="form-item-value">
						<textarea name="content" class="width-9 ui-widget ui-widget-content ui-corner-all"></textarea>
					</div>
