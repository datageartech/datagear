...
(function(po)
{
	...
	po.templateEditorCompletionsJsFunction = [
		...
		{name: "dashboard.isWaitForRender", value: "isWaitForRender(", caption: "isWaitForRender()", meta: " dashboard"},
		{name: "dashboard.isWaitForUpdate", value: "isWaitForUpdate(", caption: "isWaitForUpdate()", meta: " dashboard"},
		...
		{name: "chart.echartsInstance", value: "echartsInstance(", caption: "echartsInstance() ", meta: "chart"},
		...
		{name: "chart.eventBindHandlerDelegation", value: "eventBindHandlerDelegation(", caption: "eventBindHandlerDelegation() ", meta: "chart"},
		...
		{name: "chart.eventUnbindHandlerDelegation", value: "eventUnbindHandlerDelegation(", caption: "eventUnbindHandlerDelegation() ", meta: "chart"},
		{name: "chart.extValue", value: "extValue(", caption: "extValue() ", meta: "chart"},
		{name: "chart.getUpdateResults", value: "getUpdateResults()", caption: "getUpdateResults() ", meta: "chart"},
