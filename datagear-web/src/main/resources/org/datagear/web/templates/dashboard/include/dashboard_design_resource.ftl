...
<div class="h-full relative">
	<div class="absolute pt-1" style="z-index:1;right:0;">
		<p-button class="px-2 py-1" severity="secondary" text @click="onShowGlobalRes"
	...
	<p-tabview class="light-tabview flex flex-column h-full" @tab-change="onResourceTabChange" :pt="{navContainer:{'class':'flex-grow-0'},panelContainer:{'class':'flex-grow-1'}}">
		<p-tabpanel :pt="{root:{'class':'h-full'}}" header="<@spring.message code='localResource' />">
