...
<div id="${pid}" class="page page-manager page-dataexchange page-import-data-excel h-full flex flex-column overflow-auto">
...
(function(po)
{
	po.submitUrl = "/dtbsSourceExchange/"+encodeURIComponent(po.dtbsSourceId)+"/import/excel/doImport";
	...
	po.setupImportTableHead(
			po.concatContextPath("/dtbsSourceExchange/"+encodeURIComponent(po.dtbsSourceId)+"/import/excel/uploadImportFile"),
			function(response)
			{
