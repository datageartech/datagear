...
<title><#include "include/html_appNamePrefix.ftl">数据源</title>
</head>
<body>
...
<div id="${pid}" class="page-list">
	...
	<div class="page-list-content">
		<p-datatable :value="product.items" :scrollable="true" scroll-height="flex"
			...
			<p-column field="id" header="标题" :sortable="true"></p-column>
			<p-column field="name" header="URL" :sortable="true"></p-column>
