...
<title><fmt:message key='<%=titleOperationMessageKey%>' /><fmt:message key='titleSeparator' /><%=ModelUtils.getNameLabelValue(model, WebUtils.getLocale(request))%><%@ include file="../include/html_title_app_name.jsp" %></title>
</head>
<body>
