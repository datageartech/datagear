...
CREATE INDEX DG_INDEX_DS_CREATE_USER_ID ON DATAGEAR_DATA_SET(DS_CREATE_USER_ID);
...
CREATE INDEX DG_INDEX_HCW_CREATE_USER_ID ON DATAGEAR_HTML_CHART_WIDGET(HCW_CREATE_USER_ID);
...
CREATE INDEX DG_INDEX_HD_CREATE_USER_ID ON DATAGEAR_HTML_DASHBOARD(HD_CREATE_USER_ID);
