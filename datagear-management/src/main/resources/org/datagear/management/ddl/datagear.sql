...
--2020-12-09
--添加内置角色
INSERT INTO DATAGEAR_ROLE VALUES('ROLE_REGISTRY', '注册用户', '系统新添加和注册的用户都会自动添加至此用户组', 'true', CURRENT_TIMESTAMP);
...
--将所以已注册用户关联至[注册用户]角色
INSERT INTO DATAGEAR_ROLE_USER SELECT 'RU' || USR.USER_ID, 'ROLE_REGISTRY', USR.USER_ID FROM DATAGEAR_USER USR;
