...
--看板分享设置
CREATE TABLE DATAGEAR_DASHBOARD_SHARE_SET
(
	DBSS_ID VARCHAR(50) NOT NULL,
	DBSS_ENABLE_PASSWORD VARCHAR(20),
	DBSS_PASSWORD  VARCHAR(200)
);

ALTER TABLE DATAGEAR_DASHBOARD_SHARE_SET ADD CONSTRAINT DG_PK_DBSS_ID PRIMARY KEY (DBSS_ID);

ALTER TABLE DATAGEAR_DASHBOARD_SHARE_SET ADD CONSTRAINT DG_FK_DBSS_ID FOREIGN KEY (DBSS_ID) REFERENCES DATAGEAR_HTML_DASHBOARD (HD_ID) ON DELETE CASCADE;
