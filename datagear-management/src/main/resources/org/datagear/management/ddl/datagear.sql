...
CREATE INDEX INDEX_DS_CREATE_USER_ID ON DATAGEAR_DATA_SET(DS_CREATE_USER_ID);
...
ALTER TABLE DATAGEAR_DATA_SET_PAR ADD CONSTRAINT FK_DS_PAR_DS_ID FOREIGN KEY (PAR_DS_ID) REFERENCES DATAGEAR_DATA_SET (DS_ID) ON DELETE CASCADE;
...
ALTER TABLE DATAGEAR_DATA_SET_SQL ADD CONSTRAINT FK_DS_SQL_SCHEMA_ID FOREIGN KEY (DS_SCHEMA_ID) REFERENCES DATAGEAR_SCHEMA (SCHEMA_ID);

ALTER TABLE DATAGEAR_DATA_SET_SQL ADD CONSTRAINT FK_DS_SQL_DS_ID FOREIGN KEY (DS_ID) REFERENCES DATAGEAR_DATA_SET (DS_ID) ON DELETE CASCADE;
...
ALTER TABLE DATAGEAR_DATA_SET_JSON_VALUE ADD CONSTRAINT FK_DS_JSONV_DS_ID FOREIGN KEY (DS_ID) REFERENCES DATAGEAR_DATA_SET (DS_ID) ON DELETE CASCADE;
...
ALTER TABLE DATAGEAR_DATA_SET_JSON_FILE ADD CONSTRAINT FK_DS_JSONF_DS_ID FOREIGN KEY (DS_ID) REFERENCES DATAGEAR_DATA_SET (DS_ID) ON DELETE CASCADE;

ALTER TABLE DATAGEAR_DATA_SET_JSON_FILE ADD CONSTRAINT FK_DS_JSONF_DSRD_ID FOREIGN KEY (DS_DSRD_ID) REFERENCES DATAGEAR_DSR_DIRECTORY (DD_ID);
...
ALTER TABLE DATAGEAR_DATA_SET_EXCEL ADD CONSTRAINT FK_DS_EXCEL_DS_ID FOREIGN KEY (DS_ID) REFERENCES DATAGEAR_DATA_SET (DS_ID) ON DELETE CASCADE;

ALTER TABLE DATAGEAR_DATA_SET_EXCEL ADD CONSTRAINT FK_DS_EXCEL_DSRD_ID FOREIGN KEY (DS_DSRD_ID) REFERENCES DATAGEAR_DSR_DIRECTORY (DD_ID);
...
ALTER TABLE DATAGEAR_DATA_SET_CSV_VALUE ADD CONSTRAINT FK_DS_CSVV_DS_ID FOREIGN KEY (DS_ID) REFERENCES DATAGEAR_DATA_SET (DS_ID) ON DELETE CASCADE;
...
ALTER TABLE DATAGEAR_DATA_SET_CSV_FILE ADD CONSTRAINT FK_DS_CSVF_DS_ID FOREIGN KEY (DS_ID) REFERENCES DATAGEAR_DATA_SET (DS_ID) ON DELETE CASCADE;

ALTER TABLE DATAGEAR_DATA_SET_CSV_FILE ADD CONSTRAINT FK_DS_CSVF_DSRD_ID FOREIGN KEY (DS_DSRD_ID) REFERENCES DATAGEAR_DSR_DIRECTORY (DD_ID);
...
ALTER TABLE DATAGEAR_DATA_SET_HTTP ADD CONSTRAINT FK_DS_HTTP_DS_ID FOREIGN KEY (DS_ID) REFERENCES DATAGEAR_DATA_SET (DS_ID) ON DELETE CASCADE;
...
ALTER TABLE DATAGEAR_HTML_CHART_WIDGET ADD CONSTRAINT FK_HCW_AP_ID FOREIGN KEY (HCW_AP_ID) REFERENCES DATAGEAR_ANALYSIS_PROJECT (AP_ID);

CREATE INDEX INDEX_HCW_CREATE_USER_ID ON DATAGEAR_HTML_CHART_WIDGET(HCW_CREATE_USER_ID);
...
ALTER TABLE DATAGEAR_HCW_DS ADD CONSTRAINT FK_HCW_ID FOREIGN KEY (HCW_ID) REFERENCES DATAGEAR_HTML_CHART_WIDGET (HCW_ID) ON DELETE CASCADE;

ALTER TABLE DATAGEAR_HCW_DS ADD CONSTRAINT FK_HCW_DS_ID FOREIGN KEY (DS_ID) REFERENCES DATAGEAR_DATA_SET (DS_ID);
...
ALTER TABLE DATAGEAR_HTML_DASHBOARD ADD CONSTRAINT FK_HD_AP_ID FOREIGN KEY (HD_AP_ID) REFERENCES DATAGEAR_ANALYSIS_PROJECT (AP_ID);

CREATE INDEX INDEX_HD_CREATE_USER_ID ON DATAGEAR_HTML_DASHBOARD(HD_CREATE_USER_ID);
