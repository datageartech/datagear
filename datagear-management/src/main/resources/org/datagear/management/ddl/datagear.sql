...
/*2025-05-18*/
/*JSON数据集添加附加数据的JSON属性配置列*/
ALTER TABLE DATAGEAR_DATA_SET_JSON_VALUE ADD COLUMN DS_DATA_JSON_PATH VARCHAR(200);

ALTER TABLE DATAGEAR_DATA_SET_JSON_VALUE ADD COLUMN DS_ADTND_PROPS VARCHAR(500);

ALTER TABLE DATAGEAR_DATA_SET_JSON_FILE ADD COLUMN DS_ADTND_PROPS VARCHAR(500);

/*2025-05-18*/
/*数据集添加描述列*/
ALTER TABLE DATAGEAR_DATA_SET ADD COLUMN DS_DESC VARCHAR(500);

/*2025-06-06*/
/*图表和看板添加描述列*/
ALTER TABLE DATAGEAR_HTML_CHART_WIDGET ADD COLUMN HCW_DESC VARCHAR(500);

ALTER TABLE DATAGEAR_HTML_DASHBOARD ADD COLUMN HD_DESC VARCHAR(500);


/*-----------------------------------------*/
/*--version[5.4.1], DO NOT EDIT THIS LINE!*/
/*-----------------------------------------*/
...
VALUES('MYSQL_DISABLE_LOADLOCAL_1','jdbc:mysql:*allowLoadLocalInfile*','false',999,'true',CURRENT_TIMESTAMP,'MySQL禁用URL参数allowLoadLocalInfile','*','[]','true','ANY');

INSERT INTO DATAGEAR_SCHEMA_GUARD (SG_ID,SG_PATTERN,SG_PERMITTED,SG_PRIORITY,SG_ENABLED,SG_CREATE_TIME,SG_NAME,SG_USER_PATTERN,SG_PROP_PATTERNS,SG_EMPTY_PPT_FA,SG_PROP_MATCH_MODE)
VALUES('MYSQL_DISABLE_LOADLOCAL_2','jdbc:mysql:*allowLoadLocalInfileInPath*','false',999,'true',CURRENT_TIMESTAMP,'MySQL禁用URL参数allowLoadLocalInfileInPath','*','[]','true','ANY');
...
/*2026-09-21*/
/*数据源防护表添加计算表达式列*/
ALTER TABLE DATAGEAR_SCHEMA_GUARD ADD COLUMN SG_EVAL_EXP VARCHAR(200);

/*添加URL和连接属性防护数据，不允许包含"a-z"、"A-Z"的"%*"编码值，防止编码"allowLoadLocalInfile"等风险参数*/
INSERT INTO DATAGEAR_SCHEMA_GUARD (SG_ID,SG_PATTERN,SG_PERMITTED,SG_PRIORITY,SG_ENABLED,SG_CREATE_TIME,SG_NAME,SG_USER_PATTERN,SG_PROP_PATTERNS,SG_EMPTY_PPT_FA,SG_PROP_MATCH_MODE,SG_EVAL_EXP)
VALUES('DISABLE_ENCODED_A_Z','regex:.*%(4[1-9A-Fa-f]|5[0-9Aa]|6[1-9A-Fa-f]|7[0-9Aa]).*','false',999,'true',CURRENT_TIMESTAMP,'禁用URL和连接属性英文字母编码','*','[{"namePattern":"regex:.*%(4[1-9A-Fa-f]|5[0-9Aa]|6[1-9A-Fa-f]|7[0-9Aa]).*","valuePattern":"*"}]','true','ANY', '(url || props) && user');

/*添加MySQL的JDBC的propertiesTransform参数防护数据*/
INSERT INTO DATAGEAR_SCHEMA_GUARD (SG_ID,SG_PATTERN,SG_PERMITTED,SG_PRIORITY,SG_ENABLED,SG_CREATE_TIME,SG_NAME,SG_USER_PATTERN,SG_PROP_PATTERNS,SG_EMPTY_PPT_FA,SG_PROP_MATCH_MODE,SG_EVAL_EXP)
VALUES('MYSQL_DISABLE_PROPTRANS_1','jdbc:mysql:*propertiesTransform*','false',999,'true',CURRENT_TIMESTAMP,'MySQL禁用URL参数propertiesTransform','*','[]','true','ANY','');

INSERT INTO DATAGEAR_SCHEMA_GUARD (SG_ID,SG_PATTERN,SG_PERMITTED,SG_PRIORITY,SG_ENABLED,SG_CREATE_TIME,SG_NAME,SG_USER_PATTERN,SG_PROP_PATTERNS,SG_EMPTY_PPT_FA,SG_PROP_MATCH_MODE,SG_EVAL_EXP)
VALUES('MYSQL_DISABLE_PROPTRANS_2','jdbc:mysql:*','false',999,'true',CURRENT_TIMESTAMP,'MySQL禁用连接属性propertiesTransform','*','[{"namePattern":"propertiesTransform","valuePattern":"*"}]','true','ANY','');

/*添加MySQL的JDBC的socketFactory参数防护数据*/
INSERT INTO DATAGEAR_SCHEMA_GUARD (SG_ID,SG_PATTERN,SG_PERMITTED,SG_PRIORITY,SG_ENABLED,SG_CREATE_TIME,SG_NAME,SG_USER_PATTERN,SG_PROP_PATTERNS,SG_EMPTY_PPT_FA,SG_PROP_MATCH_MODE,SG_EVAL_EXP)
VALUES('MYSQL_DISABLE_SOCKETFACT_1','jdbc:mysql:*socketFactory*','false',999,'true',CURRENT_TIMESTAMP,'MySQL禁用URL参数socketFactory','*','[]','true','ANY','');

INSERT INTO DATAGEAR_SCHEMA_GUARD (SG_ID,SG_PATTERN,SG_PERMITTED,SG_PRIORITY,SG_ENABLED,SG_CREATE_TIME,SG_NAME,SG_USER_PATTERN,SG_PROP_PATTERNS,SG_EMPTY_PPT_FA,SG_PROP_MATCH_MODE,SG_EVAL_EXP)
VALUES('MYSQL_DISABLE_SOCKETFACT_2','jdbc:mysql:*','false',999,'true',CURRENT_TIMESTAMP,'MySQL禁用连接属性socketFactory','*','[{"namePattern":"socketFactory","valuePattern":"*"}]','true','ANY','');
