...
/*2026-09-18*/
/*添加URL和参数防护数据，不允许包含"a-z"、"A-Z"的"%*"编码值，防止编码"allowLoadLocalInfile"等风险参数*/
INSERT INTO DATAGEAR_SCHEMA_GUARD (SG_ID,SG_PATTERN,SG_PERMITTED,SG_PRIORITY,SG_ENABLED,SG_CREATE_TIME,SG_NAME,SG_USER_PATTERN,SG_PROP_PATTERNS,SG_EMPTY_PPT_FA,SG_PROP_MATCH_MODE)
VALUES('DISABLE_ENCODED_A_Z_1','regex:.*%(4[1-9A-Fa-f]|5[0-9Aa]|6[1-9A-Fa-f]|7[0-9Aa]).*','false',999,'true',CURRENT_TIMESTAMP,'禁用URL中的英文字母编码','*','[]','true','ANY');

INSERT INTO DATAGEAR_SCHEMA_GUARD (SG_ID,SG_PATTERN,SG_PERMITTED,SG_PRIORITY,SG_ENABLED,SG_CREATE_TIME,SG_NAME,SG_USER_PATTERN,SG_PROP_PATTERNS,SG_EMPTY_PPT_FA,SG_PROP_MATCH_MODE)
VALUES('DISABLE_ENCODED_A_Z_2','*','false',999,'true',CURRENT_TIMESTAMP,'禁用连接属性中的英文字母编码','*','[{"namePattern":"regex:.*%(4[1-9A-Fa-f]|5[0-9Aa]|6[1-9A-Fa-f]|7[0-9Aa]).*","valuePattern":"*"}]','true','ANY');
