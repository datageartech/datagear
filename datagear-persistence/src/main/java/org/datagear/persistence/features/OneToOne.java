 ...
 * <p>
 * 由属性端决定关联关系的存储方式（双向关联），属性端的映射属性必须无{@linkplain MappedBy}。
 * </p>
 * </li>
 ...
 * {@linkplain ModelKeyPropertyName}指定，必须有属性端ID列，列名称默认或者使用
 ...
 * {@linkplain ModelKeyColumnName}指定，对应属性端外键属性默认为ID属性或者使用
 * {@linkplain PropertyKeyPropertyName}指定。
 * </p>
 * </li>
 ...
 * </p>
 * <p>
 * 此类的设计参考自{@code javax.persistence.OneToOne}。
 * </p>
 * 
 * @author datagear@163.com
 *
 */
public interface OneToOne extends PropertyFeature, PersistenceFeature
{
}
