...
{
	public static final String JSON_PROPERTY_TYPE = HtmlChartPlugin.PROPERTY_TYPE;
	...
	{
		String type = convertToString(properties.get(JSON_PROPERTY_TYPE));
		type = HtmlChartPluginType.normalize(type);

		chartPlugin.setType(type);
